...
import { regular, veg, restaurant_order_detail, api_url, img_url, bold, cancel } from '../config/Constants';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={{ padding: 10 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ flexDirection:'row',backgroundColor:colors.theme_bg_three, borderBottomWidth:0.5, borderColor:colors.grey}}>
          <View style={{ width:'100%', justifyContent:'center', alignItems:'flex-start', paddingBottom:10,}}>
        ...
        <View style={{ backgroundColor:colors.theme_bg_three, borderBottomWidth:0.5, borderColor:colors.grey,flexDirection:'row',}}/>        
        <View style={{ margin:10 }} />
        <Text style={{ color:colors.theme_fg_two, fontFamily:regular, fontSize:18 }}>Order details <Text style={{color:colors.theme_fg, fontFamily:bold, fontSize:14}}>[{order_details.status}]</Text></Text>
        <View style={{ margin:5 }} />
        <View style={{ flexDirection:'row', backgroundColor:colors.theme_bg_three, borderBottomWidth:0.5, borderColor:colors.grey}}/>
        <View style={{ margin:5 }} />
